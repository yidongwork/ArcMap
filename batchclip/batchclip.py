...
for row in rows:
	...
	outputExtent=str(ext.XMin)+" "+str(ext.YMin)+" "+str(ext.XMax)+" "+str(ext.YMax)
	arcpy.Clip_management(rasterLayer,outputExtent,outputName, plotFeatureLayer, "#", "ClippingGeometry")
